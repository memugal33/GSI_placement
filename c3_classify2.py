...
reclassify = 'reclassified'  ## This will be the name of the file that you reclassify
summtab = 'summ_tab'  ### This will be the name of summary table
fc = "prj_py_h12"        ### This is the study area projected feature class that will be used for clipping
gdb = "mygdb.gdb"  ## This is the gdb that will be created
sens = "sensit_tab" ## This is the final sensitivity table that will be created
...
args = "{} 3.829685 0;3.829685 6.121095 1;6.121095 9.329070 2;9.329070 {} 3".format(mini, maxi)  ## This is how the HSI raster will be classified

fish_nem = "fsh_200_clp2.shp" ### What is the name of the fishnet file?
wd = "100" ## what should be the width of the fishnet
ht = "100" ### What should be the height of the fishnet
zones = 'pfish_c200_clip.shp' ## This will be my zone layer ### This is also the layer obtained after cliping the fishnet output to the study area
...
arcpy.Clip_analysis(wspc+"\\"+fish_nem_prj, fc, zones, '#') ## Clip it to the size of study area
...
import pandas as pd
import numpy as np
my = arcpy.da.TableToNumPyArray(wspc+"\\"+summtab, (myoid, "VALUE_0","VALUE_1","VALUE_2","VALUE_3"))

ana = pd.DataFrame(my)

ana["tot"]=ana[["VALUE_0","VALUE_1","VALUE_2","VALUE_3"]].sum(axis=1)
...
ana['Sensitivity'] = ana[["p0","p1","p2","p3"]].apply(cont, axis = 1)
...
output = "jnt_finale" ## want new output from this
