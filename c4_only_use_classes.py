...
un_unsuit = "un_unsuit_wsp.shp" ### What do you want to name the unionof all the unsuitable areas?
eras1 = "aft_er_msk_wsp.shp" ### what do you want to name the first erased layer
hsi1 = "suit_hsi_spp.tif" ### what do you want to name the hsi layer which has filtered out the first label of unsuitable area
...
kst = "k_mperd_ras_c_1_829.tif" ## hydraulic conductivity layer
...
recls_k = "recls_ksatwsp"  ### what should be the name of the reclassed k layer
...
recls_d = "recls_sdwsp"  ### what should be the name of the reclassed depth layer
...
d_arr = "drn_arr22" ## name of drainage area
args3 = 'Con("{}" < 30000, 100,200)'.format(d_arr) ##This is how the contributing area will be classified
recls_a = "recls_cawsp"  ### what should be the name of the reclassed contributing area layer

ss = "slp" ## hydraulic conductivity layer
sss = arcpy.Raster(ss) ### This is the hydraulic conductivity layer that is in m per day in 6ft res
mini4 = sss.minimum
maxi4 = sss.maximum
args4_0 = '{} 5 1000;5 20 2000;20 {} 3000'.format(mini4, maxi4)  ##This is how the ksat will be classified
recls_sss = "recls_sss"  ### what should be the name of the reclassed k layer
...
args4 = '"{}"+"{}"+"{}"+"{}"'.format(recls_k,recls_d,recls_a, recls_sss)
fin_suit = "cmb_sutwslp" ## This is the name for all suitable layers combinations




#### We need 2000+ 100 + 20 + 2 = 2122
v_n = 2122
args5 = 'Value = {}'.format(v_n)
extrct_lyr = "extrt_sut_wsp"


###Final layer name
fin_hsi_arr = "fin_hsi_w_slp"
...
arcpy.gp.Reclassify_sa(sss, 'VALUE', args4_0, recls_sss, 'DATA')
